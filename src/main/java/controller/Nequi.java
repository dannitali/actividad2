...
import models.NequiDao;
import models.NequiVo;

public class Nequi extends HttpServlet{
    
    NequiVo r=new NequiVo();
    NequiDao rd=new NequiDao();
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        switch (accion) {
            ...
            case "Usuarios":
                ...
                break;
            case "Nequi-add":
                req.getRequestDispatcher("Nequi-add.jsp").forward(req, resp);
                break;
            case "Nequi-modificar":
                req.getRequestDispatcher("Nequi-modificar.jsp").forward(req, resp);
                break;
            case "abrirForm":
                abrirForm(req, resp);
                break;
